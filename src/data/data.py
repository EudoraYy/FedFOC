    ...
    for i in range(num_users):
        ...
        for rand in rand_set:
            dict_users_train[i] = np.concatenate((dict_users_train[i], \
                                                  idxs_train[rand * num_imgs_train_per_shard:(
                                                                                                         rand + 1) * num_imgs_train_per_shard]),
                                                 axis=0)

            user_labels = np.concatenate(
                (user_labels, labels_train[rand * num_imgs_train_per_shard:(rand + 1) * num_imgs_train_per_shard]),
                axis=0)
